...
export default function AudienceTypeModal({ mode, category, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = mode === 'edit' 
        ? `/api/dashboard/audienceType/${category._id}`
        : '/api/dashboard/audienceType';
