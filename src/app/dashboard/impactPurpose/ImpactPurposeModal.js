...
export default function ImpactPurposeModal({ mode, category, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = mode === 'edit' 
        ? `/api/dashboard/impactPurpose/${category._id}`
        : '/api/dashboard/impactPurpose';
