...
export default function IntentModal({ mode, category, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = mode === 'edit' 
        ? `/api/dashboard/intent/${category._id}`
        : '/api/dashboard/intent';
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.header}>
          <h2>{mode === 'edit' ? 'ویرایش نوع تعامل' : 'نوع تعامل جدید'}</h2>
          ...
          <div className={styles.formRow}>
            ...
            <div className={styles.formGroup}>
              ...
              <input
                ...
                placeholder="مثلاً: ENTERTAINMENT"
                required
