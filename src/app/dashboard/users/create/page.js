...
export default function CreateUserPage() {
  ...
  const handleRoleChange = (role) => {
    ...
    if (currentRoles.includes(role)) {
      // Remove role (but keep at least 'user')
          ...
          <div className={styles.tabContent}>
            <div className={styles.formRow}>
              ...
              <div className={styles.formGroup}>
                ...
                />
                <small>اگر خالی بگذارید، کاربر باید OTP استفاده کند</small>
              </div>
            </div>
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                ...
                >
                  ...
                  <option value="organization_ngo">سازمانی - NGO/خیریه</option>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.rolesList}>
                {["user", "event_owner", "moderator", "admin"].map((role) => (
              ...
              <small>نقش "کاربر عادی" برای همه الزامی است</small>
            </div>
